...
![[Conhecimento Técnico/Engrenagens#Diâmetro interno ($D_i$)\|#Diâmetro interno ($D_i$)]]

$D_{i}=3(50-2,33)=3*47,67=143cm$

![[Conhecimento Técnico/Engrenagens#Diâmetro externo ($D_e$)\|#Diâmetro externo ($D_e$)]]

$D_{e}=3(50+2)=3*52=156cm$

![[Conhecimento Técnico/Engrenagens#Passo ($P$)\|#Passo ($P$)]]
$P=\pi*3=9,42cm$

![[Conhecimento Técnico/Engrenagens#Altura do dente ($h$)\|#Altura do dente ($h$)]]
$h=2,166*3=6,5mm$

![[Conhecimento Técnico/Engrenagens#Altura do pé ($f$)\|#Altura do pé ($f$)]]
$f=1,166*3=3,5cm$


![[Conhecimento Técnico/Engrenagens#Velociade periférica no $D_p$ ($v$)\|#Velociade periférica no $D_p$ ($v$)]]
...
---
## Recalculo
![[Conhecimento Técnico/Engrenagens#Diâmetro primitivo ($D_p$)\|#Diâmetro primitivo ($D_p$)]]
$D_{p}=5*17=85$
![[Conhecimento Técnico/Engrenagens#Diâmetro externo ($D_e$)\|#Diâmetro externo ($D_e$)]]
$D_{e}=5(17+2)=5(19)=95$
...
$C_{v}=\frac{5,6}{5,4+\sqrt{ 0,094 }}=\frac{5,6}{5,4+0,312}=\frac{5,6}{5,712}=0,9$
![[Conhecimento Técnico/Engrenagens#Carregamento dinâmico ($m$)\|#Carregamento dinâmico ($m$)]]
$m\geq\sqrt[3]{ \frac{2*300*1,33*1,25}{1.400 * 0,9 * 10 *0,408*50*1}}=\sqrt[3]{\frac{9.975}{257.040}}=\sqrt[3]{0,0388}=2,66$
...
![[Conhecimento Técnico/Engrenagens#Velociade periférica no $D_p$ ($v$)\|#Velociade periférica no $D_p$ ($v$)]]
$v=\frac{\pi*0,077*1.200}{60}=\frac{290,28}{60}=4,84$
![[Conhecimento Técnico/Engrenagens#Coeficiente de velocidade ou super solicitação dinâmica ($C_v$)\|#Coeficiente de velocidade ou super solicitação dinâmica ($C_v$)]]
$C_{v}=\frac{6}{6+4,84}=0,55$
![[Conhecimento Técnico/Engrenagens#Carregamento dinâmico ($m$)\|#Carregamento dinâmico ($m$)]]
